...
@Component({
    selector: '[question-input-number]',
    template: `
    <div class="col-md-3">
        <div class="form-group">
            <input type="text" name="text" class="form-control" [(ngModel)]="field.question.ansFreeText[0]"
...
export class QuestionInputNumberComponent {
